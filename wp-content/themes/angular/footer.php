		...
		<!-- ####### SOCKET CONTAINER ####### -->
			<div class='container_wrap <?php echo $extraClass; ?>' id='socket'>
				<div class='container'>
					<span class='copyright'>&copy; <?php _e('Copyright','avia_framework'); ?> - <a href='<?php echo home_url('/'); ?>'><?php echo get_bloginfo('name');?></a> - Design by <a href='http://www.wpthemes4free.org/angular-wordpress-theme-by-themeforest' target='_blank'>Kriesi</a></span>
