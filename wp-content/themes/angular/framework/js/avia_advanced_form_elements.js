			...
			var methods = 
			{
				avia_add_google_font: function()
				{
					var current = $(this),
						...
						parent = current.parents('.avia_control:eq(0)'),
						cssRule = parent.find('.google_css');
						
					cssRule.remove();
					cssRule = $('<div class="google_css"><link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family='+cssValue+'" /> <style type="text/css">.avia_google_font{font-family:'+value+';}</style></div>')
