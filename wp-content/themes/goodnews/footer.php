...
<div class="bottom_bar">
    ...
    <ul class="social_icons">
        ...
        <?php if(of_get_option('skype_url') != '') { ?>
                <li class="skype"><a href="<?php echo of_get_option('skype_url'); ?>">skype</a></li>
        <?php } ?>
...
Powered by <a href="http://premiumwordpressthemesfree.com/goodnews-premium-magazine-theme">WordPress</a>