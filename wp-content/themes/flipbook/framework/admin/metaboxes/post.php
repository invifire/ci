...
$options_post[] = array( "name" => "Thumbnails height",
...
$options_post[] = array( "name" => "When the post thumbnail is clicked",
					"id" => "thumbnail_click",
...
$options_post[] = array( "name" => "Lighbox Description",
					"id" => "lighbox_description",
					"class" => "thumbnail_click thumbnail_click_1 thumbnail_click_2",
					"std" => "",
					"type" => "textarea"); 
					
$options_post[] = array( "name" => "The url of the video",
...
$options_post[] = array( "name" => "Type the adress here",
					"id" => "post_adress",
...
$options_post[] = array( "name" => "Background Type",
					"id" => "background_type",
...
$options_post[] = array( "name" => "Gallery category",
					"id" => "gallery_cat",
					"class" => "background_type background_type_2",
					"type" => "select_slideshow"); 	
					
$options_post[] = array( "name" => "Slide Interval",
				...
				$options_post[] = array( "name" => "Slide transition type",
					"id" => "transition_type",
					"class" => "background_type background_type_1 background_type_2",
					"std" => "fade",
					"options" => array(
			...
			$options_post[] = array( "name" => "Video ID (required)",
			...
			$options_post[] = array( "name" => "MP4 source URL ",
			...
			$options_post[] = array( "name" => "Ogg source URL",
				...
				$options_post[] = array( "name" => "Flash source URL ",
...
$options_post[] = array( "name" => "Page Layout",
