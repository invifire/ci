...
class FP_Widget_Related_Posts extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$query = array('tag__in' => $tagIDs,'post__not_in' => array($post->ID) ,'showposts' => $number, 'post_status' => 'publish');
			...
			<?php if (has_post_thumbnail() ): 
				...
				<div class="post_thumbnail">
					<a href="<?php echo get_permalink() ?>" title="<?php the_title();?>">
						<img src="<?php echo theme_resize($image_wp[0],70,50); ?>" title="<?php the_title();?>" alt="<?php the_title();?>"/>
					</a>
				</div>
