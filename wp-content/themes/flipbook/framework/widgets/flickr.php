...
class FP_Widget_Flickr extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div class="flickr_wrap">
			<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?user=<?php echo $flickr_id; ?>&amp;count=<?php echo $count; ?>&amp;display=<?php echo $display; ?>&amp;layout=x&amp;source=user"></script>
		</div>
