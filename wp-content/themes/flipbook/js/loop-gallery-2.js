jQuery(document).ready(function($) {
	...
	jQuery('#categories li a').unbind('click', itemClicked); jQuery('#categories li a').bind('click', itemClicked);
	...
	function make_greyscales(){
		...
		jQuery('.entry_item .image_container img').each(function(){
			var el = jQuery(this);
			el.clone().addClass('img_grayscale').css({"zIndex":"1"}).insertBefore(el).queue(function(){
				var el = jQuery(this);
				el.siblings('img').wrap("<div class='grayscale_container' style='display: block; z-index:2'>");
