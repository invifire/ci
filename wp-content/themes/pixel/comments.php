...
if (function_exists('post_password_required')) 
	...
	if ( post_password_required() ) 
		{
		echo '<p class="nocomments">Bài viết này bị đặt mật khẩu rầu. Bạn muốn xem comment thì nhập pass vào nhé :|</p>';
		return;
		}
	} else 
	{
	if (!empty($post->post_password)) 
		{ // if there's a password
			...
			{  // and it doesn't match the cookie  ?>
				<p class="nocomments">Bài viết này bị đặt mật khẩu rầu. Bạn muốn xem comment thì nhập pass vào nhé :|</p>
				<?php return;
			}
		}
	}
...
<?php else : // this is displayed if there are no comments so far ?>
	...
	else : ?><p class="nocomments">Bài viết này đã khóa Comment :|</p>
	<?php endif;
endif;
else:
...
?>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
  ...
  <?php if ('open' == $post->comment_status) : ?> 
	...
	<p class="nocomments">Bài viết này đã khóa Comment :|</p>
...
<div class="cleared"></div>
<div id="respond">
<h3>Xin để lại lời nhắn</h3><img src="http://l.yimg.com/us.yimg.com/i/mesg/emoticons7/1.gif" alt="kiss">
...
<p>Bạn cần phải <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php the_permalink(); ?>">đăng nhập</a> để đăng comment.</p></div>
<?php else : ?>
...
<a href="<?php echo $logout_link; ?>" title="Đăng xuất"><?php _e('Đăng xuất &raquo;'); ?></a></p>
<?php else : ?>

<p><input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" />
<label for="author"><small>Name <?php if ($req) echo "(bắt buộc)"; ?></small></label></p>
<p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" />
<label for="email"><small>Mail (sẽ giấu kín cho bạn) <?php if ($req) echo "(required)"; ?></small></label></p>
...
<p><input name="submit" type="submit" id="submit" class="submitbutton" tabindex="5" value="Để lại lời nhắn" />
