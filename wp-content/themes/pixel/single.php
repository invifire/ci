...
<div class="topPost">
  ...
  <div class="topContent"><?php the_content('(Đọc tiếp...)'); ?></div>
...
<br/><small><?php edit_post_link('Sửa entry?','',''); ?></small>
...
<div class="topPost">
  ...
  <div class="topContent"><p>Xin lỗi bạn, nội dung bạn cần tìm kiếm ko có ở đây :( Bạn hãy dùng <a href="#searchform">form này</a> để tìm lại nếu muốn :)...</p></div>
</div> <!-- Closes topPost -->
